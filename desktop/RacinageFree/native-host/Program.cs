  ...
  internal sealed partial class LocalServer {
    ...
    private string Page(string title, string body) {
      ...
      return "<!doctype html><html><head><meta charset='utf-8'><meta name='viewport' content='width=device-width, initial-scale=1'>" +
        "<title>" + H(title) + " - Racinage Free</title><link rel='stylesheet' href='/assets/ai-assistant.css?v=" + assetVersion + "'><link rel='stylesheet' href='/assets/floaty.css?v=" + assetVersion + "'><style>" + Css() + CalendarCss() + ShareCss() + "</style></head><body>" +
